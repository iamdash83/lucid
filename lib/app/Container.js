...
var AppContainer = module.exports = function(packageName, containerName, sandboxOptions, options, componentManager){
    ...
    //`sandboxOptions` contains options from applications.sandbox in Lucid's config
    //TODO: mix in some params from app manifest (`options`) eventually
