...
Application.prototype._startContainers = function(promise){
    ...
    for(var containerName in containers){
        ...
        var container = this._containers[containerName] = new Container(this._packageName, containerName, this._sandboxOptions, containers[containerName], this._componentManager);
